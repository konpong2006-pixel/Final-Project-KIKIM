...
const styles = StyleSheet.create({
  axisDateLabel: {color: muted, fontFamily: font.regular, fontSize: 12, marginTop: -1},
  axisLabel: {color: muted, fontFamily: font.semibold, fontSize: 12, marginTop: 3},
  ...
  averageTagText: {color: '#fff', fontFamily: font.bold, fontSize: 12},
  barTrack: {alignItems: 'center', height: 94, justifyContent: 'flex-end', position: 'relative', width: '100%'},
  barValue: {color: '#b8646b', fontFamily: font.bold, fontSize: 12, left: 0, position: 'absolute', right: 0, textAlign: 'center'},
  barValueSelected: {color: '#52639a'},
  categoryAmount: {color: ink, fontFamily: font.bold, fontSize: 12, minWidth: 72, textAlign: 'right'},
  categoryDot: {borderRadius: 5, height: 10, width: 10},
  categoryName: {color: ink, flex: 1, fontFamily: font.semibold, fontSize: 12},
  chartCard: {...shadow, backgroundColor: '#fff', borderColor: '#e4e9df', borderRadius: 19, borderWidth: 1, marginTop: 11, padding: 13},
  chartSubtitle: {color: muted, fontFamily: font.regular, fontSize: 12, marginTop: 2},
  ...
  // Widened with the axis labels. A column holds a date like "31/12" and a
  // baht figure above the bar; at 7px they fitted in 34, at 12px they did not,
  // and the month chart -- which scrolls sideways anyway -- was the tightest.
  dayColumn: {alignItems: 'center', flex: 1, justifyContent: 'flex-end', minWidth: 46, paddingTop: 5},
  ...
  dayLegendText: {color: muted, fontFamily: font.regular, fontSize: 12},
  dayScroll: {zIndex: 3},
  ...
  donutCenterLabel: {color: muted, fontFamily: font.semibold, fontSize: 12, maxWidth: 78},
  donutCenterPercent: {color: '#626fa8', fontFamily: font.bold, fontSize: 12},
  ...
  emptyText: {color: muted, fontFamily: font.regular, fontSize: 12, lineHeight: 18, marginTop: 3, textAlign: 'center'},
  emptyTitle: {color: ink, fontFamily: font.bold, fontSize: 13, marginTop: 8},
  emptyTextInline: {color: muted, fontFamily: font.regular, fontSize: 12, lineHeight: 18, marginTop: 2},
  eyebrow: {color: '#626fa8', fontFamily: font.bold, fontSize: 12, letterSpacing: .5},
  headingCopy: {flex: 1},
  ...
  legendPercent: {color: muted, fontFamily: font.semibold, fontSize: 12, marginTop: 1},
  ...
  maxLabel: {color: muted, fontFamily: font.semibold, fontSize: 12, marginLeft: 'auto'},
  monthDayChart: {flexGrow: 0, minWidth: 1450},
  monthDayColumn: {flex: 0, minWidth: 46},
  ...
  selectionAmount: {color: '#52639a', fontFamily: font.extra, fontSize: 12},
  selectionCaption: {color: '#8a91aa', fontFamily: font.semibold, fontSize: 12},
  selectionLabel: {color: '#737d9d', fontFamily: font.semibold, fontSize: 12, maxWidth: 150},
  ...
  totalLabel: {color: muted, fontFamily: font.semibold, fontSize: 12},
