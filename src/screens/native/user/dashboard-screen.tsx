...
const styles = StyleSheet.create({
  seedAction: {color: colors.sageDark, fontFamily: font.bold, fontSize: 11},
  ...
  seedSub: {color: colors.muted, fontFamily: font.regular, fontSize: 10, lineHeight: 15, marginTop: 1},
  ...
  collapsedText: {color: '#7b8476', flex: 1, fontFamily: font.regular, fontSize: 10, lineHeight: 15},
  ...
  dynamicText: {color: colors.sageDark, fontFamily: font.semibold, fontSize: 10},
  doneButton: {alignItems: 'center', backgroundColor: colors.sageDark, borderRadius: 11, flexDirection: 'row', gap: 4, minHeight: 40, paddingHorizontal: 10},
  doneText: {color: '#fff', fontFamily: font.bold, fontSize: 10},
  ...
  noteEyebrow: {color: colors.note, fontFamily: font.semibold, fontSize: 10},
  ...
  priorityCaption: {color: colors.muted, fontFamily: font.regular, fontSize: 10, lineHeight: 15, marginBottom: 8, marginTop: 3},
  ...
  priorityItemSub: {color: colors.muted, fontFamily: font.regular, fontSize: 10, lineHeight: 15, marginTop: 1},
  ...
  quickQuestion: {color: colors.pine, flex: 1, fontFamily: font.regular, fontSize: 10},
  quickValue: {color: colors.pine, fontFamily: font.bold, fontSize: 10},
  ...
  reasonText: {color: colors.sageDark, fontFamily: font.semibold, fontSize: 9},
  reasonWrap: {flexDirection: 'row', flexWrap: 'wrap', gap: 4, marginTop: 5},
  roomRow: {alignItems: 'center', flexDirection: 'row', marginTop: 3},
  roomText: {color: '#899284', fontFamily: font.regular, fontSize: 10},
  ...
  seeAll: {color: colors.sageDark, fontFamily: font.semibold, fontSize: 11},
  ...
  statLabel: {color: colors.muted, fontFamily: font.regular, fontSize: 10, marginTop: 1, textAlign: 'center'},
  ...
  tagText: {color: '#73799f', fontFamily: font.medium, fontSize: 9},
  ...
  taskTime: {color: colors.muted, fontFamily: font.regular, fontSize: 10},
  taskTitle: {color: colors.pine, fontFamily: font.semibold, fontSize: 11},
